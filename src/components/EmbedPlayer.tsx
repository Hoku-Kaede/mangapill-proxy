import { AlertTriangle, CheckCircle2, ChevronLeft, Gauge, MonitorPlay, RefreshCw, Subtitles, XCircle } from 'lucide-react';
...
// Full-screen embed player with auto-probed server list. The subtitles live
// inside each embed provider's own player (its CC menu); this view provides the
// server changer + auto-best selection on top.
      ...
      <div className="flex-1 overflow-y-auto bg-black">
        {scanning && statuses === null ? (
          ...
          <div className="p-4 sm:p-6">
            <div className="relative bg-black rounded-xs overflow-hidden" style={{ aspectRatio: '16/9' }}>
              <iframe
                src={activeUrl}
